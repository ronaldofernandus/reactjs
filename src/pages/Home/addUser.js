...
import { getUser, addUser } from "../../Axios/userAxios";
const AddUser = () => {
  ...
  const { addNewUserResult } = useSelector((state) => state.userReducers);
  ...
  const addHandler = (event) => {
    ...
    Swal.fire({
      ...
      text: `You've successfully created User!`,
    });
    navigate("/");
  };
